...
const IssueCard = ({ it }) => {
    return (
        <article key={it._id} className="bg-base-100 rounded-xl overflow-hidden shadow-md hover:shadow-xl transform transition duration-300 hover:-translate-y-1">
            ...
            <div className="p-4">
                ...
                <p className="text-sm text-base-content/90 mb-3">{it.description}</p>
                <div className="flex items-center justify-between">
                    <div className="text-xs text-base-content/80">{it.location}</div>
