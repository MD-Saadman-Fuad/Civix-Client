            ...
            <div className="navbar bg-base-100 shadow-sm h-20 p-2">
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1 gap-4">
                        <NavLink to="/" className={({ isActive }) => `rounded-full px-4 py-2 shadow font-semibold transition-colors duration-200 ${isActive ? 'bg-orange-500 text-white' : 'bg-white text-orange-500 border border-orange-500 '}`}>
                        ...
                        <NavLink to="/issues" className={({ isActive }) => `rounded-full px-4 py-2 shadow font-semibold transition-colors duration-200 ${isActive ? 'bg-orange-500 text-white' : 'bg-white text-orange-500 border border-orange-500'}`}>
                            <span className="inline-flex items-center gap-2">
                        ...
                        {user ? (
                            <>
                                <NavLink to="/add-issues" className={({ isActive }) => `rounded-full px-4 py-2 shadow font-semibold transition-colors duration-200 ${isActive ? 'bg-orange-500 text-white' : 'bg-white text-orange-500 border border-orange-500'}`}>
                                    <span className="inline-flex items-center gap-2">
                                ...
                                <NavLink to="/my-issues" className={({ isActive }) => `rounded-full px-4 py-2 shadow font-semibold transition-colors duration-200 ${isActive ? 'bg-orange-500 text-white' : 'bg-white text-orange-500 border border-orange-500'}`}>
                                    <span className="inline-flex items-center gap-2">
                                ...
                                <NavLink to="/my-contributions" className={({ isActive }) => `rounded-full px-4 py-2 shadow font-semibold transition-colors duration-200 ${isActive ? 'bg-orange-500 text-white' : 'bg-white text-orange-500 border border-orange-500'}`}>
                                    <span className="inline-flex items-center gap-2">
                ...
                <div className="navbar-end gap-3 ">
                    ...
                    <div className="dropdown">
                        ...
                        <ul
                            ...
                            {user ? (
                                ...
                                <li>
                                    <NavLink onClick={handleSignOut} className={({ isActive }) => `rounded-full px-4 py-2 shadow font-semibold transition-colors duration-200 ${isActive ? 'bg-orange-500 text-white' : 'bg-white text-orange-500 border border-orange-500'}`}>
                                        <span className="inline-flex items-center gap-2">
                    ...
                    {loading ? (
                        ...
                        <div className="flex gap-2">
                            <NavLink to="/login" className="btn bg-orange-500 hover:bg-orange-600 text-white rounded-full inline-flex items-center gap-2">
                            ...
                            <NavLink to="/register" className="btn bg-orange-500 hover:bg-orange-600 text-white rounded-full inline-flex items-center gap-2">
